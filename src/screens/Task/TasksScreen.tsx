...
import { getWorkOrderList } from '../../api/network-utils'
    ...
    <View style={{flex: 1/* , borderWidth: 3 */}}>
      <View style={[styles.searchTaskContainer, shadowStyles]}>
        <View style={styles.createTaskContainer}>
          ...
          <CustomButton textStyle={PRIMARY_BUTTON_TEXT_STYLES} buttonStyle={[PRIMARY_BUTTON_STYLES, styles.createTask, {marginTop: 10, marginBottom: 10}]} icon={<CirclePlus width={15} height={15} />} iconPosition="right" onPress={() => {}} title={"Create Task"} />
        </View>
